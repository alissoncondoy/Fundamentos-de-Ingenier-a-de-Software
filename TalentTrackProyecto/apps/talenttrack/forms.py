...
class EmpleadoUsuarioAltaForm(TTBaseForm):
    ...
    email = forms.EmailField(label="Correo del empleado")
    ...
    # Usuario
    usuario_email = forms.EmailField(label="Correo del usuario")
    usuario_phone = forms.CharField(max_length=50, required=False, label="Teléfono del usuario")
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Aplicar placeholders suaves
        self.fields["email"].widget.attrs.setdefault("placeholder", "empleado@empresa.com")
        self.fields["usuario_email"].widget.attrs.setdefault("placeholder", "usuario@empresa.com")
    ...
    def save(self):
        ...
        usr = Usuario(
            empresa_id=empresa.id,
            email=self.cleaned_data["usuario_email"].lower().strip(),
            phone=(self.cleaned_data.get("usuario_phone") or "").strip() or None,
            empleado_id=emp.id,
            estado=None,

...
from ..presentation.views.ajax import AjaxUnidades, AjaxPuestos, AjaxEmpleados, AjaxManagers, AjaxRoles, AjaxTurnos
...
from ..presentation.views.employees import (
    ...
    MiPerfil, MiPerfilEdit, MiPerfilPassword,
)
...
from ..presentation.views.evaluations import EvaluacionList, EvaluacionCreate, EvaluacionUpdate, EvaluacionDelete

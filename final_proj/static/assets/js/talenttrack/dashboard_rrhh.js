(function () {
  ...
  function ttAlpha(color, a) {
    if (!color || color.indexOf("rgba") === 0) return color;
  ...
  const COLORS = {
    horas: ttVar('--tt-hours', '#3b82f6'),
    extra: ttVar('--tt-extra', '#f59e0b'),
    ok: ttVar('--tt-success', '#22c55e'),
    warn: ttVar('--tt-warning', '#fbbf24'),
    bad: ttVar('--tt-danger', '#ef4444'),
  };
  const ALPHAS = { fill: .18, line: 1 };
          ...
          datasets: [
            {
              ...
              backgroundColor: ALPHAS.success,
              pointRadius: 0,
              borderWidth: 2,
              fill: true,
            },
            {
              ...
              backgroundColor: ALPHAS.warning,
              pointRadius: 0,
              borderWidth: 2,
              fill: true,
            },
    ...
    if (ctxK) {
      ...
      chartKpi = new Chart(ctxK, {
        ...
        data: {
          ...
          datasets: [
            {
              data: [sem.verde || 0, sem.amarillo || 0, sem.rojo || 0],
              backgroundColor: [COLORS.success, COLORS.warning, COLORS.danger],
              borderColor: [ALPHAS.success, ALPHAS.warning, ALPHAS.danger],
              borderWidth: 1,
            },
          ],
        },

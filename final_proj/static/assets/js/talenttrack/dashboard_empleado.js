(function () {
  ...
  // Theme-aware colors (fallbacks keep charts readable even without CSS vars)
  ...
  const TT_COLORS = {
    ...
    verde: ttVar("--tt-success", "#22c55e"),
    amarillo: ttVar("--tt-warning", "#fbbf24"),
    rojo: ttVar("--tt-danger", "#ef4444"),
  };
          ...
          datasets: [
            {
              ...
              data: c.horas || [],
              tension: 0.4,
              borderColor: COLORS.hours,
              backgroundColor: ALPHAS.hourFill,
              pointRadius: 2,
              borderWidth: 2,
              fill: true,
            },
            {
              ...
              backgroundColor: ALPHAS.extraFill,
              pointRadius: 2,
              borderWidth: 2,
              fill: true,
            },
